...
| A7 | 52–60 | Avatar + URL card `second-brain.lovable.app` | "Built in seven days by a three-person team. Try it — second-brain dot lovable dot app." |
...
| Pricing card | *to generate (`imagegen`, premium) before Reel A render* | ⏳ |
| URL/outro card | *to generate (premium, text legibility)* | ⏳ |
...
- [ ] Avatar = Daisy / Professional — or override: ______
- [ ] Voice = Adam Conversational — or override: ______
- [ ] Pricing line = Free / $12 / $39 per seat — or override: ______
- [ ] URL in outro = `second-brain.lovable.app` — or override: ______
